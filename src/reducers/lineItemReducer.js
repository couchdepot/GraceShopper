...
// After updating will fetch all the line items for the cart
export const updateLineItem = (lineItemId, quantity, cartId) => {
  return dispatch => {
    return axios
      .put(`api/lineItems/${lineItemId}`, { lineItemId, quantity, cartId })
